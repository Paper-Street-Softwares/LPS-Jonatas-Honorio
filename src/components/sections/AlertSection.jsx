...
export default function AlertSection() {
  return (
    <section className="relative w-full bg-white py-20 px-6 text-justify">
      <div className="max-w-[1215px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <MotionDivDownToUp>
          <div className="flex flex-col gap-8">
            {/* Frase de impacto */}
            <div className="border-l-4 border-red-800 pl-3 pr-3 py-4 bg-terciary rounded-r-lg font-secondFont ">
